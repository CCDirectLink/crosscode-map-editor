...
import { LangLabelComponent } from './lang-label-widget/lang-label/lang-label.component';
...
@NgModule({
	...
	declarations: [COMPONENTS, PRIVATE_COMPONENTS, CharacterWidgetComponent, LangLabelComponent],

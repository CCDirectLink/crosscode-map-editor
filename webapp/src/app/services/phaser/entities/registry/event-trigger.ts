...
export class EventTrigger extends CCEntity {
	private attributes: EntityAttributes = {
		eventType: {
			type: 'String',
			description:
				"Type of event. Cutscenes will stop the movement of the player and can't be executed in parallel. " +
		...
		loadCondition: {
			...
			description:
				'If true: condition is checked on map entry and event is only loaded if true. onStart => Use start conditions, custom => use custom conditions',
			I: true,
		},
	};

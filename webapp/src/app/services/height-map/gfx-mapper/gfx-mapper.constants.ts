...
map['BASE'][GFX_TYPE.NORTH] = [
	[2, 0],
	[3, 0],
];
map['BASE'][GFX_TYPE.EAST] = [
	[3, 1],
	[3, 2],
];
map['BASE'][GFX_TYPE.SOUTH] = [
	[2, 3],
	[3, 3],
];
map['BASE'][GFX_TYPE.WEST] = [
	[2, 1],
	[2, 2],
];
map['BASE'][GFX_TYPE.DIAGONAL_NE] = [
	[4, 0],
	[5, 1],
];
map['BASE'][GFX_TYPE.DIAGONAL_SE] = [
	[4, 3],
	[5, 2],
];
map['BASE'][GFX_TYPE.DIAGONAL_SW] = [
	[0, 2],
	[1, 3],
];
map['BASE'][GFX_TYPE.DIAGONAL_NW] = [
	[0, 1],
	[1, 0],
];
...
map['BASE'][GFX_TYPE.WALL_SOUTH] = [
	[3, 4],
	[2, 4],
];
map['BASE'][GFX_TYPE.WALL_SE] = [
	[5, 3],
	[4, 4],
];
map['BASE'][GFX_TYPE.WALL_SW] = [
	[1, 4],
	[0, 3],
];
map['BASE'][GFX_TYPE.WALL_SOUTH_BASE] = [
	[2, 5],
	[3, 5],
];
map['BASE'][GFX_TYPE.WALL_SE_BASE] = [
	[4, 5],
	[5, 4],
];
map['BASE'][GFX_TYPE.WALL_SW_BASE] = [
	[0, 4],
	[1, 5],
];
map['BASE'][GFX_TYPE.WALL_END_WEST] = [
	[0, 6],
	[0, 7],
];
map['BASE'][GFX_TYPE.WALL_END_WEST_BASE] = [
	[0, 6],
	[0, 7],
];
map['BASE'][GFX_TYPE.WALL_END_EAST] = [
	[5, 6],
	[5, 7],
];
map['BASE'][GFX_TYPE.WALL_END_EAST_BASE] = [
	[5, 6],
	[5, 7],
];

map['ALT'].offset = { x: 0, y: 6 };
map['ALT'][GFX_TYPE.WALL_SOUTH] = [
	[3, 0],
	[2, 0],
];
map['ALT'][GFX_TYPE.WALL_SE] = [
	[5, 0],
	[4, 0],
];
map['ALT'][GFX_TYPE.WALL_SW] = [
	[1, 0],
	[0, 0],
];
...
map['BACK_WALL'][GFX_TYPE.EAST] = [
	[3, 3],
	[4, 2],
];
map['BACK_WALL'][GFX_TYPE.WEST] = [
	[1, 2],
	[2, 3],
];
...
map['SUB']['BASE'][GFX_TYPE.WALL_SOUTH_BASE] = [
	[2, 4],
	[3, 4],
];
map['SUB']['BASE'][GFX_TYPE.WALL_SE_BASE] = [
	[4, 4],
	[5, 3],
];
map['SUB']['BASE'][GFX_TYPE.WALL_SW_BASE] = [
	[0, 3],
	[1, 4],
];

map['SUB']['SHADOW'].offset = { x: 0, y: 5 };
map['SUB']['SHADOW'][GFX_TYPE.NORTH] = [
	[2, 0],
	[3, 0],
];
map['SUB']['SHADOW'][GFX_TYPE.DIAGONAL_NW] = [
	[0, 0],
	[1, 0],
];
map['SUB']['SHADOW'][GFX_TYPE.DIAGONAL_NE] = [
	[4, 0],
	[5, 0],
];
map['SUB']['SHADOW'][GFX_TYPE.WEST] = [
	[0, 1],
	[1, 1],
];
map['SUB']['SHADOW'][GFX_TYPE.EAST] = [
	[5, 1],
	[4, 1],
];

map['SUB']['BACK_WALL'].offset = { x: 0, y: 7 };
map['SUB']['BACK_WALL'][GFX_TYPE.NORTH] = [
	[2, 0],
	[3, 0],
];
map['SUB']['BACK_WALL'][GFX_TYPE.DIAGONAL_NW] = [
	[0, 0],
	[1, 0],
];
map['SUB']['BACK_WALL'][GFX_TYPE.DIAGONAL_NE] = [
	[4, 0],
	[5, 0],
];
map['SUB']['BACK_WALL'][GFX_TYPE.WEST] = [
	[0, 1],
	[1, 1],
];
map['SUB']['BACK_WALL'][GFX_TYPE.EAST] = [
	[5, 1],
	[4, 1],
];
...
map['SUB'].ignoreTerrainKeepWallBase = [
	GFX_TYPE.WALL_SOUTH,
	GFX_TYPE.WALL_SE,
	GFX_TYPE.WALL_SW,
	GFX_TYPE.WALL_SQR_SE,
...
export const BASE_GFX = [
	GFX_TYPE.WALL_SOUTH_BASE,
	GFX_TYPE.WALL_SE_BASE,
	GFX_TYPE.WALL_SW_BASE,
];
...
export const SHADOW_GROUND = [
	GFX_TYPE.DIAGONAL_NE,
	GFX_TYPE.DIAGONAL_NW,
	GFX_TYPE.NORTH,
	GFX_TYPE.EAST,
	GFX_TYPE.WEST,
	GFX_TYPE.CORNER_NE,
